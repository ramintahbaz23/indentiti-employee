...
import getApprovalRequestsPaginated from '@salesforce/apex/ApprovalRequestsController.getApprovalRequestsPaginated';
...
export default class ApprovalRequestsPage extends LightningElement {
    ...
    loadData() {
        this.isLoading = true;
        getApprovalRequestsPaginated({ filters: {}, searchQuery: this.searchQuery, sortColumn: this.sortColumn, sortDirection: this.sortDirection, pageSize: this.pageSize, pageNumber: this.currentPage })
